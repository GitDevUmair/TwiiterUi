      ...
      <div className="alltweets" style={{ marginTop: "2rem" }}>
        ...
        >
          ...
          >
            ...
            >
              <div style={{display : 'flex' , alignItems :'center' , gap : '7px'}}><FaRegComment /><span style={{fontSize : '12px'}}>5</span></div>
              <div style={{display : 'flex' , alignItems :'center' , gap : '7px'}}><FaRetweet /><span style={{fontSize : '12px'}}>30</span></div>
              <div style={{display : 'flex' , alignItems :'center' , gap : '7px'}}><AiOutlineHeart /><span style={{fontSize : '12px'}}>180</span></div>
              <div style={{display : 'flex' , alignItems :'center' , gap : '7px'}}><LuView /><span style={{fontSize : '12px'}}>14.8k</span></div>
              <div><FaShare /></div>
            </div>
          </div>
        </div>
